...
const SavePage = () => {
	...
	const toggleSave = async (rawId) => {
		try {
			...
			const [kind, id] =
				rawId.includes(":") ? rawId.split(":") : ["interview", rawId];
	...
	}; // to fetch the applied jobs for the users

	//   so that a user can apply on a job once
	...
	// small component for the company card
	...
	// the rest of the code is for the ui
	return (
