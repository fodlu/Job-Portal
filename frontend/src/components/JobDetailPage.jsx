...
const JobDetailPage = () => {
	...
	}; // it will return the value like 26 days ago
	...
	const getLocationColor = "bg-blue-100 text-blue-700 border-blue-200";
					...
					<div className={s.detailsGrid}>
						{[
							...
							<div
								...
								<div
									className={`${s.detailIconWrapper} ${
										index === 0 ? s.detailIconWrapperBlue
										: index === 1 ? s.detailIconWrapperPurple
										: index === 2 ? s.detailIconWrapperGreen
										: index === 3 ? s.detailIconWrapperOrange
										: s.detailIconWrapperPink
									}`}>
									<item.icon
										className={`${s.detailIcon} ${
											index === 0 ? s.detailIconBlue
											: index === 1 ? s.detailIconPurple
											: index === 2 ? s.detailIconGreen
											: index === 3 ? s.detailIconOrange
											: s.detailIconPink
										}`}
									/>
								</div>
