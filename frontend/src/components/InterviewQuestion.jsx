                ...
                <div>
                    <section className={s.section}>
                        <div className={s.sectionHeader}>
                            ...
                            <Link to="/roles" className={s.viewAllLink}>View All Roles <ChevronRight className={s.chevronIcon} /> </Link>
                        </div>
...
function CompanyCard ({company}) {
    ...
    const initials = company.companyName ? company.companyName.split(" ").map((w) => w[0]).slice(0, 2).join('') : "??"
                    ...
                    <div className={s.cardLeftFlex}>
                        <div className={s.logoContainer(colorClass)} style={{width: 56, height: 56, overflow: 'hidden'}}>
                            {!imgError && company.logo ? (
                                ...
                                <span className={s.logoFallbackText}></span>
                            )}
                        </div>
