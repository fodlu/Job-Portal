...
const Banner = () => {
	// these codes are written for animation
					...
					<div className={s.grid}>
						<div className={s.leftColumn}>
							...
							<p className={s.description}>
								...
								professionals who found their career match through our advanced
						...
						<div className={s.rightColumn}>
							<div
								className={`${s.cardContainer} ${isXL ? "hover: rotate-y-12 rotate-0" : "rotate-0"}`}>
								<div className={s.card}>
									<div className={s.cardHeader}>
										<div className='flex items-center gap-3 '>
											...
											<div>
												<h3 className={s.featuredTitle}>Featured Job</h3>
												...
												<div className={s.jobItemFlex}>
													<div className={s.jobItemLeft}>
														...
														<div className={s.salaryContainer}>
															...
															<div className={s.salaryPeriod}>per years</div>
														</div>
													</div>
