    ...
    <div className={s.pageContainer}>
        ...
        <div className={s.contentWrapper}>
            <header className={s.header}>
                ...
                <p className={s.headerSubtitle}>Add company details and upload a question bank CSV (Question, Answer, KeyPoints, PostDate optional).</p>
            </header>
                    ...
                    <div className={s.gridRow}>
                        <div className={s.colSpan2}>
                            ...
                            <div className={s.inputWrapper}>
                                ...
                                <input type="text" value={companyName} onChange={e=> setCompanyName(e.target.value)} className={`${s.inputField} ${errors.companyName ? s.inputError : s.inputDefault}`} placeholder='Company Name' />
                            </div>
                            {errors.companyName && (
                        ...
                        <div>
                            <label className={s.label}>
                                Question (total) <span className={s.requiredStar}>*</span>
                            </label>
                            <div className={s.inputWrapper}>
                                <FileText size={18} className={s.inputIcon} />
                                <input type="text" value={questionsCount} onChange={e=> setQuestionsCount(e.target.value)} className={`${s.inputField} ${errors.questionsCount ? s.inputError : s.inputDefault}`} placeholder='Total Questions' />
                            </div>
                            ...
                            <div className={s.countHelperRow}>
                                {errors.questionsCount ? (
                                    ...
                                    <p className={s.countHelperText}>
                                        Display: {" "}
                                        <span className={s.countDisplayValue}>{formatCountShort(parsedCountForDisplay)}</span>
                                    </p>
                                )}

                                <p className={s.countHint}>
                                    You can use number like 1600 or 10k+
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className={s.logoPreviewWrapper}>
                                {logoPreview ? (
                                    <div className={s.logoPreviewBox}>
                                        ...
                                        {/* button to remove image after preview */}
