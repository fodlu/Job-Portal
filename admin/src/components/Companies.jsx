...
import { CheckCircle, Link2, Loader2, Trash2, Upload, X, XCircle } from 'lucide-react';
            ...
            <div className={s.formCard}>
                <form onSubmit={handleSubmit} className={s.form}>
                    ...
                    <div className="">
                        ...
                        <div className={s.logoContainer}>
                            ...
                            <div className={s.uploadArea}>
                                ...
                                <input type="file" id='logo-upload' ref={fileInputRef} accept='image/*, jpeg, jpg, image/svg+xml, .ico' onChange={(e)=> handleLogoChange(e)} className={s.fileInputHidden} />
                            </div>
                        </div>
                            {errors.logo && (
                                <p className={s.errorText}>{errors.logo}</p>
                            )}
                    </div>
                    ...
                    <div className={s.inputWrapper}>
                        ...
                        <input type="url" value={website} onChange={(e) => setWebsite(e.target.vale)} className={`${s.websiteInput} ${errors.website ? s.inputError : s.inputDefault}`} placeholder='https:/example.com' />
                    </div>
                    ...
                    <div className={s.submitSection}>
                        <button type='submit' disabled={isLoading} className={`${s.submitBtn} ${isLoading ? s.submitBtnDisabled : ''}`}>
                            {isLoading ? (
                                <>
                        ...
                        {companies.map((c) => (
                            <div key={c._id} className={s.companyCard}>
                                ...
                                <div className={s.cardDetails}>
                                    <a href={c.website} target='_blank' rel='noreferrer' className={s.cardLink}>{c.website}</a>
                                </div>
