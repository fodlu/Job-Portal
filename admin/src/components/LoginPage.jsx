...
import { AlertCircle, CheckCircle, Eye, EyeOff, Lock, LogIn, X } from 'lucide-react';
            ...
            <form onSubmit={handleSubmit} className={s.form}>
                <div className={s.formGroup}>
                    ...
                    <div className={s.inputWrapper}>
                        ...
                        <input type="email" id="email" value={email} onChange={(e)=> setEmail(e.target.value)} className={`${s.inputBase} ${s.inputPr3}`} placeholder='admin@jobportal.com' required />
                    </div>
                </div>
                ...
                <div className={s.formGroup}>
                    ...
                    <div className={s.inputWrapper}>
                        ...
                        <input type={showPassword ? "text" : 'password'} id='password' value={password} onChange={(e)=> setPassword(e.target.value)} className={`${s.inputBase} ${s.inputPr12}`} placeholder='●●●●●' required/>

                        {/* toggle eye password */}
                        <div className={s.eyeButtonWrapper}>
                            <button type='button' onClick={()=> setShowPassword(s=> !s)} className={s.eyeButton}>
