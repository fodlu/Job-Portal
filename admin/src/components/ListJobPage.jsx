...
// if salary is not found, it will be not disclosed else it will show the period of time
...
export default function ListJobs() {
	...
	// to fetch the jobs from the server side
	...
	// to edit but will only save when we hit the save button
	const openEdit = (job) => {
	...
	return (
		<div className={s.container}>
			...
			{/* Edit Modalwhen we are in edit state */}
