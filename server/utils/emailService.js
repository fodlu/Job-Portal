...
export const sendForgotPassword = async (email, name, otp) => {
    return sendEmail({
        to: [{email, name}],
        subject: "Reset your pssword - JobPortal",
        htmlContent: otpTemplate('Reset Your Password', name, otp, "You requested to reset your passsword. Please use the following 6-digit code to proceed")
